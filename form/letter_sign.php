...
<script>
	function save_sign() {
        ...
        window.opener.document.getElementById('img_create').value = document.getElementById("sketcher").toDataURL("image/png").replace('data:image/png;base64,', '');
        window.opener.document.getElementById('view_pic').src = document.getElementById("sketcher").toDataURL("image/png");
        window.close();
	}
</script>
<pre id="events"></pre>
