                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                    <a class="btn btn-primary" href="../view/LetterDetail.php?LETTER_ID=<?php echo $value['letter_id']; ?>&menu_id=<?php echo $_GET['menu_id']; ?>&proc=Approve" role="button">อนุมัติ</a>
                                                            <?php
                                                } ?>
